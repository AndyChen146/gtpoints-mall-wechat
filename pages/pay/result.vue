	...
	<view class="container">
		<view class="pay-result">
			<view class="success" v-if="status">
			  ...
			  <view class="btns">
				<navigator class="btn" url="/pages/user/order" hover-class="none" open-type="redirect">查看订单</navigator>
				<navigator class="btn" url="/pages/index/index" hover-class="none" open-type="switchTab">继续逛</navigator>
			  </view>
			</view>
